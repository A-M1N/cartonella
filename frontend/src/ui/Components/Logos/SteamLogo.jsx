export default function SteamLogo({ className }) {
  return (
    <svg
      viewBox="0 0 233 233 "
      className={className}
    ...
    >
      <linearGradient id="steam-gradient" x1="50%" x2="50%" y2="100%">
