export default function ZaraLogo({ className }) {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      <path
        d="M508.9,501.4c0,39.3-32.8,71.2-57.5,71.2H172.1L523.4,11.4H53.7v93h24.1c0-39.3,25.4-71.1,50.2-71.1h241.3L15.9,594.4h509.6
	l0-93H508.9"
      />
      <g>
        <polygon points="918.3,576.1 918.3,576.1 918.3,576.1 	" />
        <path
          d="M1118.4,549L846.6,11.4l-249.1,538c-4.4,11.8-28.4,26.7-62.4,26.7v18.2h132.6v-18.2c-24.6,0-51-12.2-44.6-26.8L683,419.4
      ...
      <path
        d="M1226,33.9c40.4,0,73.8,10.4,73.8,23c0,100-0.2,491.5,0,491.5c0,13.4-32.9,28.3-73.4,28.3l-0.1,17.6h270.2v-16.4
	...
	c0-84.6-72.7-152.9-162.4-152.9H1226V33.9"
      />
      <path
        d="M2440,549L2168.2,11.4l-249.1,538c-4.4,11.8-28.3,27.3-62.4,27.3v17.6h132.6v-16.4c-24.6,0-50.9-14-44.6-28.6l59.9-129.9
